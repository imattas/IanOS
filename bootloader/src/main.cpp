...
constexpr BootModuleSpec kBootModuleSpecs[] = {
    ...
    {L"\\bin\\cmdline.elf", "/bin/cmdline.elf"},
    {L"\\bin\\procstat.elf", "/bin/procstat.elf"},
    ...
    {L"\\bin\\statfs.elf", "/bin/statfs.elf"},
    {L"\\bin\\filesystems.elf", "/bin/filesystems.elf"},
    {L"\\bin\\vfsstat.elf", "/bin/vfsstat.elf"},
    {L"\\bin\\file.elf", "/bin/file.elf"},
    {L"\\bin\\lsattr.elf", "/bin/lsattr.elf"},
    {L"\\bin\\namei.elf", "/bin/namei.elf"},
    {L"\\bin\\tree.elf", "/bin/tree.elf"},
    ...
    {L"\\bin\\hexdump.elf", "/bin/hexdump.elf"},
    {L"\\bin\\readelf.elf", "/bin/readelf.elf"},
    {L"\\bin\\sha256sum.elf", "/bin/sha256sum.elf"},
    {L"\\bin\\sha224sum.elf", "/bin/sha224sum.elf"},
    ...
    {L"\\bin\\cksum.elf", "/bin/cksum.elf"},
    {L"\\bin\\fold.elf", "/bin/fold.elf"},
    {L"\\bin\\printf.elf", "/bin/printf.elf"},
    {L"\\bin\\strings.elf", "/bin/strings.elf"},
    {L"\\bin\\nl.elf", "/bin/nl.elf"},
    {L"\\bin\\tr.elf", "/bin/tr.elf"},
    {L"\\bin\\sed.elf", "/bin/sed.elf"},
    {L"\\bin\\cut.elf", "/bin/cut.elf"},
    {L"\\bin\\paste.elf", "/bin/paste.elf"},
    {L"\\bin\\rev.elf", "/bin/rev.elf"},
    {L"\\bin\\tac.elf", "/bin/tac.elf"},
    {L"\\bin\\seq.elf", "/bin/seq.elf"},
    {L"\\bin\\expr.elf", "/bin/expr.elf"},
    {L"\\bin\\xargs.elf", "/bin/xargs.elf"},
    {L"\\bin\\yes.elf", "/bin/yes.elf"},
    {L"\\bin\\od.elf", "/bin/od.elf"},
    {L"\\bin\\base64.elf", "/bin/base64.elf"},
    {L"\\bin\\which.elf", "/bin/which.elf"},
    ...
    {L"\\bin\\devices.elf", "/bin/devices.elf"},
    {L"\\bin\\irqstat.elf", "/bin/irqstat.elf"},
    {L"\\bin\\interrupts.elf", "/bin/interrupts.elf"},
    {L"\\bin\\mmstat.elf", "/bin/mmstat.elf"},
    {L"\\bin\\buddyinfo.elf", "/bin/buddyinfo.elf"},
    {L"\\bin\\heapinfo.elf", "/bin/heapinfo.elf"},
    {L"\\bin\\procvmstat.elf", "/bin/procvmstat.elf"},
    {L"\\bin\\netstat.elf", "/bin/netstat.elf"},
    {L"\\bin\\route.elf", "/bin/route.elf"},
    ...
    {L"\\bin\\modinfo.elf", "/bin/modinfo.elf"},
    ...
    {L"\\bin\\proccomm.elf", "/bin/proccomm.elf"},
    ...
    {L"\\bin\\abi.elf", "/bin/abi.elf"},
    {L"\\bin\\features.elf", "/bin/features.elf"},
    ...
    {L"\\bin\\pstree.elf", "/bin/pstree.elf"},
