...
const char* const kExternalCommands[] = {
    "hello", "args", "cat", "ls", "uname", "hostname", "free", "uptime", "date", "rtc", "cal", "dmesg", "kmsg", "loadavg", "ps", "processes", "pwd", "env",
