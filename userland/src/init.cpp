...
const char* const kExternalCommands[] = {
    ...
    "sysinfo", "id", "ids", "ctx", "echo", "sleep", "true", "false", "touch", "append", "rm", "cp", "mv", "wc", "grep", "tee", "mkdir", "rmdir", "err",
    "stat", "whoami", "basename", "dirname", "head", "tail", "test", "sort", "uniq", "sh", "duptest", "fds", "lsof", "fdinh", "ln", "readlink", "truncate", "blk", "mount", "df", "du", "pipeinfo", "kill", "killall", "pgrep", "uyield", "ubusy", "slowcat", "burst", "loop",
};
