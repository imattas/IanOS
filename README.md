...
`args one two`, `fastfetch`, `sysctl -a`, `find /proc/sys`, `hexdump /disk/bootsector.bin`, `readelf /bin/readelf.elf`, `date`, or `/bin/cat.elf /bin/args.elf`. Input is echoed; Backspace,
