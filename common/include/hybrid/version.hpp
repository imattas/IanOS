...
#define HYBRID_OS_VERSION "0.1.101"
#define HYBRID_MACHINE "x86_64"
#define HYBRID_OS_RELEASE "0.1.101-x86_64"
#define HYBRID_KERNEL_NAME "Mattas"
#define HYBRID_KERNEL_VERSION "0.1.101-stable"
#define HYBRID_KERNEL_FLAVOR "stable"
#define HYBRID_KERNEL_TYPE "hybrid"
#define HYBRID_KERNEL_DISPLAY "Mattas 0.1.101-stable"
#define HYBRID_PROC_VERSION "Mattas 0.1.101-stable x86_64 uefi hybrid"
