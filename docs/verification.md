...
- requires runtime markers for boot, ACPI table diagnostics, ACPI/APIC/IOAPIC routing, PCI, boot-module
  ...
  `/proc/sys/vm/total_pages`, `/proc/sys/vm/mapped_pages`,
  ...
  `/proc/sys/kernel/features`, `/proc/sys/kernel/abi_version`,
